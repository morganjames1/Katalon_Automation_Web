...
WebUI.callTestCase(findTestCase('CURA Healthcare Service/LoginSucces'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Testing Katalon')
