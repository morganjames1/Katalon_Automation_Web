...
WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM/a_Welcome Pauls'), 10)

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Welcome Pauls'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Logout'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_OrangeHRM/div_LOGIN Panel'), 'LOGIN Panel')
